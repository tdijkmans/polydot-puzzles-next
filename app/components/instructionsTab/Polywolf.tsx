...
const Polywolf = (props: SVGProps<SVGSVGElement>) => {
	...
	useEffect(() => {
		...
		const currentCircle = document.getElementById(
			sequence[currentStep]?.circle,
		);
		const previousCircle = document.getElementById(
			sequence[previousStep]?.circle,
		);
		...
		const currentLetter = document.getElementById(
			sequence[currentStep]?.letter,
		);
		const previousLetter = document.getElementById(
			sequence[previousStep]?.letter,
		);
		...
		if (previousLine && previousCircle && previousText && previousLetter) {
			...
			previousText.style.fill = "none";
			// previousLetter.style.color = "green";
		}
	}, [currentStep]);
			...
			<div style={{ display: "flex" }}>
				{sequence.map((s, index) => (
					<div
						key={index}
						id={s.letter}
						style={{ color: index === currentStep ? "red" : "green" }}
					>
			...
			>
				<g transform="matrix(.21098 0 0 .21098 1.682 0)">
					...
					<g transform="matrix(1.99262 0 0 1.99262 -501.384 -701.339)">
						<circle cx={400} cy={669} {...circleStyle} id="circle_aa" />
						<text x={400} y={669} {...textStyle} id="text_aa">
							{"aa"}
						</text>

						<circle cx={364} cy={652} {...circleStyle} id="circle_ab" />
						<text x={364} y={652} {...textStyle} id="text_ab">
							{"ab"}
						</text>

						<circle cx={308} cy={655} {...circleStyle} id="circle_ac" />
						<text x={308} y={655} {...textStyle} id="text_ac">
							{"ac"}
						</text>

						<circle cx={277} cy={640} {...circleStyle} id="circle_ad" />
						<text x={277} y={640} {...textStyle} id="text_ad">
							{"ad"}
						</text>

						<circle cx={256} cy={609} {...circleStyle} id="circle_ae" />
						<text x={256} y={609} {...textStyle} id="text_ae">
							{"ae"}
						</text>

						<circle cx={252} cy={587} {...circleStyle} id="circle_af" />
						<text x={252} y={587} {...textStyle} id="text_af">
							{"af"}
						</text>

						<circle cx={334} cy={540} {...circleStyle} id="circle_ag" />
						<text x={334} y={540} {...textStyle} id="text_ag">
							{"ag"}
						</text>

						<circle cx={341} cy={533} {...circleStyle} id="circle_ah" />
						<text x={341} y={533} {...textStyle} id="text_ah">
							{"ah"}
						</text>

						<circle cx={327} cy={506} {...circleStyle} id="circle_ai" />
						<text x={327} y={506} {...textStyle} id="text_ai">
							{"ai"}
						</text>

						<circle cx={377} cy={544} {...circleStyle} id="circle_aj" />
						<text x={377} y={544} {...textStyle} id="text_aj">
							{"aj"}
						</text>

						<circle cx={423} cy={550} {...circleStyle} id="circle_ak" />
						<text x={423} y={550} {...textStyle} id="text_ak">
							{"ak"}
						</text>

						<circle cx={433} cy={528} {...circleStyle} id="circle_al" />
						<text x={433} y={528} {...textStyle} id="text_al">
							{"al"}
						</text>

						<circle cx={400} cy={518} {...circleStyle} id="circle_am" />
						<text x={400} y={518} {...textStyle} id="text_am">
							{"am"}
						</text>

						<circle cx={386} cy={501} {...circleStyle} id="circle_an" />
						<text x={386} y={501} {...textStyle} id="text_an">
							{"an"}
						</text>

						<circle cx={415} cy={491} {...circleStyle} id="circle_ao" />
						<text x={415} y={491} {...textStyle} id="text_ao">
							{"ao"}
						</text>

						<circle cx={438} cy={458} {...circleStyle} id="circle_ap" />
						<text x={438} y={458} {...textStyle} id="text_ap">
							{"ap"}
						</text>

						<circle cx={438} cy={435} {...circleStyle} id="circle_aq" />
						<text x={438} y={435} {...textStyle} id="text_aq">
							{"aq"}
						</text>

						<circle cx={385} cy={450} {...circleStyle} id="circle_ar" />
						<text x={385} y={450} {...textStyle} id="text_ar">
							{"ar"}
						</text>

						<circle cx={351} cy={480} {...circleStyle} id="circle_as" />
						<text x={351} y={480} {...textStyle} id="text_as">
							{"as"}
						</text>

						<circle cx={341} cy={496} {...circleStyle} id="circle_at" />
						<text x={341} y={496} {...textStyle} id="text_at">
							{"at"}
						</text>

						<circle cx={366} cy={508} {...circleStyle} id="circle_au" />
						<text x={366} y={508} {...textStyle} id="text_au">
							{"au"}
						</text>

						<circle cx={373} cy={469} {...circleStyle} id="circle_av" />
						<text x={373} y={469} {...textStyle} id="text_av">
							{"av"}
						</text>

						<circle cx={341} cy={449} {...circleStyle} id="circle_aw" />
						<text x={341} y={449} {...textStyle} id="text_aw">
							{"aw"}
						</text>

						<circle cx={349} cy={361} {...circleStyle} id="circle_ax" />
						<text x={349} y={361} {...textStyle} id="text_ax">
							{"ax"}
						</text>

						<circle cx={464} cy={354} {...circleStyle} id="circle_ay" />
						<text x={464} y={354} {...textStyle} id="text_ay">
							{"ay"}
						</text>

						<circle cx={558} cy={502} {...circleStyle} id="circle_az" />
						<text x={558} y={502} {...textStyle} id="text_az">
							{"az"}
						</text>

						<circle cx={458} cy={696} {...circleStyle} id="circle_a1" />
						<text x={458} y={696} {...textStyle} id="text_a1">
							{"a1"}
						</text>

						<circle cx={422} cy={679} {...circleStyle} id="circle_a2" />
						<text x={422} y={679} {...textStyle} id="text_a2">
							{"a2"}
						</text>
					</g>
					<g
